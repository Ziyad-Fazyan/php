        ...
        <form action="proses4.php" method="post">
            <fieldset>
                ...
                <p>
                    ...
                    <textarea name="alamat" cols="25"></textarea>
                </p>

                <p>
                    <label>Kurir Pengiriman :</label>
                    <label class="radio">
                        <input type="radio" name="kurir" value="pos"> POS
                    </label>
                    <label class="radio">
                        <input type="radio" name="kurir" value="jne"> JNE
                    </label>
                    <label class="radio">
                        <input type="radio" name="kurir" value="tiki"> TIKI
                    </label>
                </p>
